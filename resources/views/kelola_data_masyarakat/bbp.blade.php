...
<div class="layoutWelcome bg-white py-4 px-9 mb-5 rounded-lg">
    <div class="row d-flex align-items-center">
        <div class="col-12">
            ...
            <p class="text-xs lg:text-base font-normal text-secondary">Semua data BBP dari masyarakat Desa Palasari Kecamatan Cipanas</p>
        </div>
        <!-- Modal -->
            ...
            <script>
                $(document).ready(function() {
                    $('#searchButton').on('click', function() {
                        ...
                        $.ajax({
                            url: '/data/bbp/search', // Replace with your search route
                            method: 'GET',
                            data: {
                                search: searchValue
                            },
