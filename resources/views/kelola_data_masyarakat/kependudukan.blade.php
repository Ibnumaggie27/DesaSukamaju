...
<div class="alert alert-danger">
    <ul>
        @foreach(Session::get('import_errors') as $error)
            <li>duplikat Entry pada baris {{ $error['row'] }} di file yang di import : {{ $error['message'] }}</li>
        @endforeach
    </ul>
</div>
@endif
<div class="layoutWelcome bg-white py-4 px-9 mb-5 rounded-lg">
    <div class="row d-flex align-items-center">
        ...
        <div class="col-12">
            ...
            <p class="text-xs lg:text-base font-normal text-secondary">Semua data dari masyarakat Desa Palasari Kecamatan Cipanas</p>
        </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">File Yang di Import Harus Excel</h5>
            ...
            <table id="pendudukTable" class="table table-bordered border w-full rounded-lg bg-white divide-y divide-gray overflow-hidden">
                <thead class="themeColor text-white text-center">
                    <tr>
                        ...
                        <th rowspan="2" class="textTabelTop  text-xs md:text-sm uppercase px-4 py-3 align-middle">No KK</th>
                        <th rowspan="2" class="textTabelTop  text-xs md:text-sm uppercase px-4 py-3 align-middle">NIK</th>
                        <th rowspan="2" class="textTabelTop  text-xs md:text-sm uppercase px-4 py-3 align-middle">Nama</th>
                ...
                <tbody class="divide-y divide-gray text-center">
                    ...
                    <tr>
                        ...
                        <td class="textTabelTop  text-xs md:text-sm uppercase px-4 py-3 align-middle">{{ $item->noKK }}</td>
