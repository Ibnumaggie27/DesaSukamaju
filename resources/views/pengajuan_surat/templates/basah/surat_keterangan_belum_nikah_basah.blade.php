    ...
    <div style="margin-top: 50px;">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td class="fs-1"> : {{ ucwords(strtolower($surat->pendidikan_trakhir)) }}</td>
            </tr>
            <tr>
        ...
        <div class="fs-1" style="margin-top: 20px;">Berdasarkan pengakuan dari yang bersangkutan serta Surat Pengantar dari Ketua RT/RW 
            setempat dan data yang ada pada kantor kami. Dengan ini menerangkan dengan sebenarnya bahwa yang bersangkutan di atas <span style="font-weight: bold;">{{ ucwords(strtolower($surat->benar_nikah)) }}</span>.</div>
