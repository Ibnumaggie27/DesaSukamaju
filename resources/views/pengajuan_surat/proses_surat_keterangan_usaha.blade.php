...
@section('content')
    ...
    <h1 class="text-2xl text-center my-8">Proses Surat Keterangan Usaha</h1>
            ...
            <div class="flex flex-col lg:flex-row gap-5 justify-center">
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="no_kk"
                        ...
                        placeholder="Nomor KK" value="{{ old('no_kk', $surat->no_kk) }}" readonly/>
                    @error('no_kk')
                        <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="jenis_usaha"
                        ...
                        placeholder="Jenis Usaha" value="{{ old('jenis_usaha', $surat->jenis_usaha) }}" readonly/>
                    @error('jenis_usaha')
                        <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="selama"
                        ...
                        placeholder="Sudah Berapa Lama Usaha ini di Jalankan" value="{{ old('selama', $surat->selama) }}" readonly/>
                    @error('selama')
                        <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="alamat_usaha"
                        ...
                        placeholder="Alamat Usaha" value="{{ old('alamat_usaha', $surat->alamat_usaha) }}" readonly/>
                    @error('alamat_usaha')
                        <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="keperluan_surat"
                        ...
                        placeholder="Keperluan Surat" value="{{ old('keperluan_surat', $surat->keperluan_surat) }}" readonly/>
                    @error('keperluan_surat')
                        <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    <label class="after:ml-0.5 after:text-danger">Berlaku Surat Mulai</label>
                    <input type="text" name="berlaku_mulai"
                        ...
                        placeholder="Berlaku Surat Mulai" value="{{ old('berlaku_mulai', $surat->berlaku_mulai) }}" readonly/>
                    @error('berlaku_mulai')
                        <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
