...
<div class="bg-white py-6 px-9 mb-5 rounded-lg">
    <h1 class="text-2xl text-center my-8">Proses Surat Keterangan Belum nikah</h1>
        ...
        <div class="flex flex-col lg:flex-row gap-5 justify-center">
            <div class="w-full 
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="kk_nik" class="mt-1 px-3 py-2 @error('kk_nik') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="NIK/ No. KK" value="{{ old('kk_nik', $surat->kk_nik) }}" readonly />
                    @error('kk_nik')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="w-full
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="pendidikan_trakhir" class="mt-1 px-3 py-2 @error('pendidikan_trakhir') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Pendidikan Trakhir" value="{{ old('pendidikan_trakhir', $surat->pendidikan_trakhir) }}" readonly />
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="perlu" class="mt-1 px-3 py-2 @error('perlu') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Keperluan Surat" value="{{ old('perlu', $surat->perlu) }}" readonly />
                    @error('perlu')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="benar_nikah" class="mt-1 px-3 py-2 @error('benar_nikah') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Status Pernikahan" value="{{ old('benar_nikah', $surat->benar_nikah) }}" readonly />
                    @error('benar_nikah')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
