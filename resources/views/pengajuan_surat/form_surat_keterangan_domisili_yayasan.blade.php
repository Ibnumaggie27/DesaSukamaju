        ...
        <div class="flex flex-col  gap-5 justify-center">
            <div class="w-full 
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="nama_pimpinan" class="mt-1 px-3 py-2 @error('nama_pimpinan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Nama Pimpinan" value="{{ old('nama_pimpinan') }}" />
                    @error('nama_pimpinan')
            ...
            <div class="w-full
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="nama_yayasan" class="mt-1 px-3 py-2 @error('nama_yayasan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Nama Yayasan" value="{{ old('nama_yayasan') }}" />
                    @error('nama_yayasan')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="jenis_yayasan" class="mt-1 px-3 py-2 @error('jenis_yayasan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Jenis/Klasifikasi Yayasan" value="{{ old('jenis_yayasan') }}" />
                    @error('jenis_yayasan')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="alamat_yayasan" class="mt-1 px-3 py-2 @error('alamat_yayasan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Alamat Yayasan" value="{{ old('alamat_yayasan') }}" />
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="akta_pendirian" class="mt-1 px-3 py-2 @error('akta_pendirian') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Akta Pendirian" value="{{ old('akta_pendirian') }}" />
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="sk_kemenkumham" class="mt-1 px-3 py-2 @error('sk_kemenkumham') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="SK Kemenkumham" value="{{ old('sk_kemenkumham') }}" />
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="jumlah_pengurus" class="mt-1 px-3 py-2 @error('jumlah_pengurus') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Jumlah_pengurus" value="{{ old('jumlah_pengurus') }}" />
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="penanggung_jawab_yayasan" class="mt-1 px-3 py-2 @error('penanggung_jawab_yayasan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Penanggung Jawab Yayasan" value="{{ old('penanggung_jawab_yayasan') }}" />
