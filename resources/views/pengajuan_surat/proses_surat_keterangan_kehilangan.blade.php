...
<div class="bg-white py-6 px-9 mb-5 rounded-lg">
    <h1 class="text-2xl text-center my-8">Proses Surat Keterangan Kehilangan</h1>
        ...
        <div class="flex flex-col lg:flex-row gap-5 justify-center">
            <div class="w-full 
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="kk_nik" class="mt-1 px-3 py-2 @error('kk_nik') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Nomor KK/NIK" value="{{ old('kk_nik', $surat->kk_nik) }}" readonly />
                    @error('kk_nik')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="kewarganegaraan" class="mt-1 px-3 py-2 @error('kewarganegaraan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Warga Negara" value="{{ old('kewarganegaraan', $surat->kewarganegaraan) }}" readonly />
            ...
            <div class="w-full
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="nama_barang" class="mt-1 px-3 py-2 @error('nama_barang') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Nama Barang" value="{{ old('nama_barang', $surat->nama_barang) }}" readonly />
                    @error('nama_barang')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="tgl_hilang" class="mt-1 px-3 py-2 @error('tgl_hilang') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Hari/Tgl. Kehilangan" value="{{ old('tgl_hilang', $surat->tgl_hilang) }}" readonly />
                    @error('tgl_hilang')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="waktu_hilang" class="mt-1 px-3 py-2 @error('waktu_hilang') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Waktu Kehilangan" value="{{ old('waktu_hilang', $surat->waktu_hilang) }}" readonly />
                    @error('waktu_hilang')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="lokasi_hilang" class="mt-1 px-3 py-2 @error('lokasi_hilang') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="lokasi Kehilangan" value="{{ old('lokasi_hilang', $surat->lokasi_hilang) }}" readonly />
                    @error('lokasi_hilang')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="keperluan" class="mt-1 px-3 py-2 @error('keperluan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="keperluan" value="{{ old('keperluan', $surat->keperluan) }}" readonly />
                    @error('keperluan')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
