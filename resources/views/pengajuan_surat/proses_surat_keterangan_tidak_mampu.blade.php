...
<div class="bg-white py-6 px-9 mb-5 rounded-lg">
    <h1 class="text-2xl text-center my-8">Proses Surat Keterangan Tidak Mampu</h1>
        ...
        <div class="flex flex-col lg:flex-row gap-5 justify-center">
            ...
            <div class="w-full
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="kewarganegaraan" class="mt-1 px-3 py-2 @error('warganegara') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Warga Negara" value="{{ old('kewarganegaraan', $surat->kewarganegaraan) }}" readonly />
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="pendidikan" class="mt-1 px-3 py-2 @error('pendidikan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Pendidikan" value="{{ old('pendidikan', $surat->pendidikan) }}" readonly />
                    @error('pendidikan')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="nama_ayah_ibu" class="mt-1 px-3 py-2 @error('nama_ayah_ibu') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Nama Ayah/Ibu" value="{{ old('nama_ayah_ibu', $surat->nama_ayah_ibu) }}" readonly />
                    @error('nama_ayah_ibu')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="alamat_lengkap" class="mt-1 px-3 py-2 @error('alamat_lengkap') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Alamat Lengkap" value="{{ old('alamat_lengkap', $surat->alamat_lengkap) }}" readonly />
