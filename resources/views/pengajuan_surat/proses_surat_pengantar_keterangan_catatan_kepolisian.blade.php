...
@section('content')
    ...
    <h1 class="text-2xl text-center my-8">Proses Surat Pengantar Keterangan Catatan Kepolisian</h1>
            ...
            <div class="flex flex-col lg:flex-row gap-5 justify-center">
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="jk"
                        ...
                        placeholder="Jenis Kelamin" value="{{ old('jk', $surat->jk) }}" readonlyreadonly/>
                    @error('jk')
                        <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="pendidikan_trakhir"
                        ...
                        placeholder="Pendidikan Trakhir" value="{{ old('pendidikan_trakhir', $surat->pendidikan_trakhir) }}" readonly/>
