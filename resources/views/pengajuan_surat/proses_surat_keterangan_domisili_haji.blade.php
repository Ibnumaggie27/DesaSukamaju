...
<div class="bg-white py-6 px-9 mb-5 rounded-lg">
    <h1 class="text-2xl text-center my-8">Proses Surat Keterangan Pengantar Domisili Haji</h1>
        ...
        <div class="flex flex-col lg:flex-row gap-5 justify-center">
            ...
            <div class="w-full
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="JK" class="mt-1 px-3 py-2 @error('JK') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="JK" value="{{ old('JK', $surat->JK) }}" readonly />
                    @error('JK')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="status_perkawinan" class="mt-1 px-3 py-2 @error('status_perkawinan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Keterangan lain-lain" value="{{ old('status_perkawinan', $surat->status_perkawinan) }}" readonly />
