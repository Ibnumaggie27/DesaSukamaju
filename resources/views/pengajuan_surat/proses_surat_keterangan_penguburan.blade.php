        ...
        <div class="flex flex-col lg:flex-row gap-5 justify-center">
            <div class="w-full 
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="pekerjaan" class="mt-1 px-3 py-2 @error('status_perkawinan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Pekerjaan" value="{{ old('pekerjaan', $surat->pekerjaan) }}" readonly />
                    @error('pekerjaan')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="w-full
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="hari_tanggal" class="mt-1 px-3 py-2 @error('hari_tanggal') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Meninggal Pada Hari/Tanggal" value="{{ old('hari_tanggal', $surat->hari_tanggal) }}" readonly />
                    @error('hari_tanggal')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="tempat_meninggal" class="mt-1 px-3 py-2 @error('tempat_meninggal') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Tempat Meninggal" value="{{ old('tempat_meninggal', $surat->tempat_meninggal) }}" readonly />
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="dikuburkan" class="mt-1 px-3 py-2 @error('dikuburkan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Dikuburkan Hari" value="{{ old('dikuburkan', $surat->dikuburkan) }}" readonly />
                    @error('dikuburkan')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="waktu" class="mt-1 px-3 py-2 @error('waktu') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Waktu" value="{{ old('waktu', $surat->waktu) }}" readonly />
                    @error('waktu')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="tempat_penguburan" class="mt-1 px-3 py-2 @error('tempat_penguburan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Tempat Penguburan" value="{{ old('tempat_penguburan', $surat->tempat_penguburan) }}" readonly />
