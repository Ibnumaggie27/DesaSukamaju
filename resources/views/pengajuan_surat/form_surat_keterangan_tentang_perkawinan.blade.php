...
<div class="bg-white rounded-md px-8 py-6 space-y-5 drop-shadow-lg">
    <form action="{{ route('pengajuan-surat.store') }}" method="POST" enctype="multipart/form-data" class="
        ...
        <div class="flex flex-col  gap-5 justify-center">
            <div class="w-full 
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="nama_laki" class="mt-1 px-3 py-2 @error('nama_laki') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Nama" value="{{ old('nama_laki',auth()->user()->nama) }}" />
                    @error('nama_laki')
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="pekerjaan_laki" class="mt-1 px-3 py-2 @error('pekerjaan_laki') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Pekerjaan Laki Laki" value="{{ old('pekerjaan_laki') }}" />
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <div class="relative">
                        <select class="appearance-none px-3 py-2 @error('kewarganegaraan_laki') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" id="grid-state" name="kewarganegaraan_laki">
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="alamat_laki" class="mt-1 px-3 py-2 @error('alamat_laki') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Alamat" value="{{ old('alamat_laki') }}" />
                    @error('alamat_laki')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="hari_nikah" class="mt-1 px-3 py-2 @error('hari_nikah') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Hari" value="{{ old('hari_nikah') }}" required />
                    @error('hari_nikah')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="tanggal_nikah" class="mt-1 px-3 py-2 @error('tanggal_nikah') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Tanggal" value="{{ old('tanggal_nikah') }}" required />
                    @error('tanggal_nikah')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="w-full 
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="nama_perempuan" class="mt-1 px-3 py-2 @error('nama_perempuan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Nama" value="{{ old('nama_perempuan',auth()->user()->nama) }}" />
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="pekerjaan_perempuan" class="mt-1 px-3 py-2 @error('pekerjaan_perempuan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Pekerjaan Perempuan" value="{{ old('pekerjaan_perempuan') }}" />
                ...
                <div class="flex flex-col mb-6">
                    <label class="after:content-['*'] after:ml-0.5 after:text-danger">Alamat</label>
                    <input type="text" name="alamat_perempuan" class="mt-1 px-3 py-2 @error('alamat_perempuan') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Alamat" value="{{ old('alamat_perempuan') }}" />
