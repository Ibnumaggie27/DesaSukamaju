...
<div class="bg-white py-6 px-9 mb-5 rounded-lg">
    <h1 class="text-2xl text-center my-8">Proses Surat Keterangan Domisili</h1>
        ...
        <div class="flex flex-col lg:flex-row gap-5 justify-center">
            <div class="w-full 
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="ttl" class="mt-1 px-3 py-2 @error('ttl') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="Tempat Tanggal Lahir" value="{{ old('ttl', $surat->ttl) }}" readonly />
                    @error('ttl')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="w-full
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="kewarganegaraan" class="mt-1 px-3 py-2 @error('warganegara') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="kewarganegaraan" value="{{ old('kewarganegaraan', $surat->kewarganegaraan) }}" readonly />
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <input type="text" name="berlaku" class="mt-1 px-3 py-2 @error('berlaku') border-danger @else border-gray @enderror focus:outline-none focus:border-gray focus:ring-gray focus:ring-1" placeholder="berlaku" value="{{ old('berlaku', $surat->berlaku) }}" readonly />
                    @error('berlaku')
                    <p class="mt-1 text-xs text-danger" id="file_input_help">{{ $message }}</p>
                    @enderror
                </div>
